...
contract SoulboundCore is Ownable, Soulbound, Allowlist {
     ...
     */
    function setBaseURI(address caller, string memory _baseURI) public onlyOwner onlyAllowlistOwner(caller) {
        /// @dev Set baseURI.
     ...
     */
    function generateTokenURI(uint256 tokenId) public view returns (string memory _tokenURI) {
