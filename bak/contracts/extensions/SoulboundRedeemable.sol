...
contract SoulboundRedeemable is IsValidWithDate, SoulboundWithSignature {
     ...
     */
    function setPrice(address caller, uint256 _price) public onlyOwner onlyAllowlistOwner(caller) {
     ...
     */
    function payToReceiveToken(address _receiver, uint256 tokenId) public payable onlyOwner nonReentrant {
     ...
     */
    function withdraw(address _caller) public onlyOwner onlyAllowlistOwner(_caller) {
