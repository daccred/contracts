...
export interface BadgeContract extends Truffle.Contract<BadgeInstance> {
    "new"(_name: string, _symbol: string, meta?: Truffle.TransactionDetails): Promise<BadgeInstance>;
}
...
export interface BadgeInstance extends Truffle.ContractInstance {
    /**
     * See {IERC721-approve}.
     */
    approve: {
