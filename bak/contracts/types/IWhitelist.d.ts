...
export interface IWhitelistContract extends Truffle.Contract<IWhitelistInstance> {
...
export interface IWhitelistInstance extends Truffle.ContractInstance {
    ...
    setWhitelistLength: {
        (_length: number | BN | string, txDetails?: Truffle.TransactionDetails): Promise<Truffle.TransactionResponse<AllEvents>>;
        call(_length: number | BN | string, txDetails?: Truffle.TransactionDetails): Promise<boolean>;
        sendTransaction(_length: number | BN | string, txDetails?: Truffle.TransactionDetails): Promise<string>;
        estimateGas(_length: number | BN | string, txDetails?: Truffle.TransactionDetails): Promise<number>;
    };
