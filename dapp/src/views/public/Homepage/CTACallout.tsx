        ...
        <div className="overflow-hidden rounded-lg shadow-xl bg-primary-700 lg:grid lg:grid-cols-2 lg:gap-4">
          <div className="px-6 pt-10 pb-12 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
            <div className="lg:self-center">
              ...
              <a
                href="#"
                className="inline-flex items-center px-5 py-3 mt-8 text-base font-medium bg-white border border-transparent rounded-md shadow text-primary-600 hover:bg-primary-50"
              >
                Sign up for free
              </a>
            </div>
