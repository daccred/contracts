...
export default function ClaimBox({ preview, claimHandler, isLoading }: ClaimPageProps) {
  ...
  return (
    <div className='bg-gray-100'>
      ...
      <main className='lg:flex md:block sm:block'>
        <div className='max-w-2xl px-4 mx-auto my-8 mt-12'>
            ...
            <div className='relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8'>
              <div className='max-w-lg mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-none lg:flex'>
                <div className='flex-1 px-6 py-8 bg-white lg:p-12'>
                  ...
                  <div className='px-6 py-8 mt-4 text-center bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12'>
                    ...
                    <p className='mt-4 text-sm'>
                      <a href='#' className='font-medium text-gray-500 underline'>
                        Clicking claim will validate your <br /> status and deploy and Hacker Badge Credential <br />{' '}
                        for you on the blockchain
                      </a>
                    </p>
                    <div className='mt-6'>
