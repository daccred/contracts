          ...
          <div className='px-6 pt-10 pb-12 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20'>
            <div className='lg:self-center'>
              ...
              <p className='mt-4 text-lg leading-6 text-primary-200'>
                Web3 Smart credential are full proof, decentralized and insured from fraud, combining them with the NFT
                implementation you are guaranteed of the highest level of authenticity
              </p>
              <a
                href='#'
