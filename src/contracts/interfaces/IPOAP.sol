...
interface IPOAP is IERC721, IERC721Metadata
{
    ...
    // Emitted when a token is minted for an event.
    ...
    /*
    * @dev:
    * Mints token `_tokenId` for a particular event `_eventId`.
    ...
    *
    * @param:
    * uint256 _eventId => The event for which the token was minted.
    * uint256 _tokenId => Token to be minted.
    */
    ...
    /*
    * @dev:
    * Mints the POAP token `_tokenId` to `_receiver`.
    *
    * @param:
    * uint256 _eventId => The event for which the token was minted.
    * address _receiver => Address receiving the token.
    * uint256 _tokenId => Token to be minted.
    */
